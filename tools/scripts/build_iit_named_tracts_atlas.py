...
3D atlas that MRLatte's existing atlas infrastructure can consume directly —
...
Usage
-----
    python tools/scripts/build_iit_named_tracts_atlas.py \
        [--bundles-dir IIT_bundles/IIT_bundles] \
        [--out-dir     data/modules/atlases/iit]
...
def main():
    ...
    ap.add_argument("--out-dir", default="data/modules/atlases/iit")
    args = ap.parse_args()
