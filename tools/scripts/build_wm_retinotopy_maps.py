...
MNI white-matter retinotopy NIfTI maps that MRLatte's existing lesion pipeline
can consume directly.

Why this exists
---------------
MRLatte already predicts visual-field involvement for lesions in *visual cortex*
...
Usage
-----
    python tools/scripts/build_wm_retinotopy_maps.py \
        --tractogram /path/to/retinotopic_connectivity_template.tck \
        [--reference   data/modules/atlases/benson14/benson14_polar_angle.nii.gz] \
        [--benson-polar data/modules/atlases/benson14/benson14_polar_angle.nii.gz] \
        [--benson-eccen data/modules/atlases/benson14/benson14_eccentricity.nii.gz] \
        [--out-dir      data/modules/atlases/wm_retinotopy] \
        [--min-support  1]
...
ATLAS_DIR = os.path.join(REPO_ROOT, "data", "modules", "atlases")
...
def main() -> int:
    ...
    ap.add_argument("--reference", default=_default("benson14", "benson14_polar_angle.nii.gz"),
                    help="NIfTI defining the output grid+affine (default: Benson polar atlas).")
    ap.add_argument("--benson-polar", default=_default("benson14", "benson14_polar_angle.nii.gz"))
    ap.add_argument("--benson-eccen", default=_default("benson14", "benson14_eccentricity.nii.gz"))
    ap.add_argument("--out-dir", default=_default("wm_retinotopy"))
