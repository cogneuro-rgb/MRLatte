...
DEFAULT_RAW    = r"Z:\Global Workspace\DaLnm\Therasa_lnm_tmap_RAW.nii.gz"  # "" to disable
...
if __name__ == "__main__":
    ...
    ap.add_argument("--raw-out", default=DEFAULT_RAW,
                    help="also save the uncorrected (pre-degree) t-map for comparison")
    ...
    print(f"saved                   : {a.out}")
    if a.raw_out:
        print(f"raw (uncorrected) saved : {a.raw_out}")
