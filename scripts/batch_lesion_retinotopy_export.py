...
a chart identical to NeuroVue's in-app "Export PNG" feature.
...
def render_polar_angle_disc_png(
    ...
    """
    Render a polar-angle disc + eccentricity bar PNG matching NeuroVue's
    ...
    ax.text(cx, fy, f'NeuroVue · {timestamp}', ha='center', va='top', fontsize=7, fontfamily='monospace', color='#888888')
...
def main():
    ...
    parser.add_argument('--polar-atlas', help='Path to polar angle atlas (default: frontend/public/atlases/benson14_polar_angle.nii.gz)')
    parser.add_argument('--eccen-atlas', help='Path to eccentricity atlas (default: frontend/public/atlases/benson14_eccentricity.nii.gz)')
    ...
    if args.polar_atlas:
        ...
        polar_atlas_path = Path(__file__).parent.parent / 'frontend' / 'public' / 'atlases' / 'benson14_polar_angle.nii.gz'

    if args.eccen_atlas:
        eccen_atlas_path = Path(args.eccen_atlas)
    else:
        eccen_atlas_path = Path(__file__).parent.parent / 'frontend' / 'public' / 'atlases' / 'benson14_eccentricity.nii.gz'
