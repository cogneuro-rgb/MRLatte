#!/usr/bin/env python3
"""
Batch lesion retinotopy export via the live NeuroVue web app (Playwright).
...
Usage:
    ...
    python scripts/batch_lesion_playwright_export.py \\
...
def process_lesion(page, lesion_path: Path, output_dir: Path, app_url: str) -> dict | None:
    """
    Load one lesion into NeuroVue, wait for retinotopy analysis, export PNG.
...
def main():
    ...
    parser.add_argument("--app-url", default=APP_URL,
                        help=f"NeuroVue app URL (default: {APP_URL})")
